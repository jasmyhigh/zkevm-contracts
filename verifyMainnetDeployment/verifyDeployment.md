...
This document ins a guide in order to verify the mainnet smart contract deployment of the zkEVM
...
In order to verify the genesis, you can the script to generate it. The script in a very similar behaviour of the last script, deploy locally the contracts and then copy the deployed bytecode into the corresponding address.
